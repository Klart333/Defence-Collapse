...
namespace RenderFeatures
{
    public class OutlinePassFinal : ScriptableRenderPass
    {
        ...
        public OutlinePassFinal(OutlineRendererFeature.Settings settings, OutlineRendererFeature.OutlineSettings outlineSettings)
        {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            var outlineData = frameData.Get<OutlineRendererFeature.OutlineData>();
