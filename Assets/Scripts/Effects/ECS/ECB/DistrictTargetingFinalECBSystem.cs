...
namespace Effects.ECS.ECB
{
    ...
    [UpdateAfter(typeof(DeathSystem)), UpdateAfter(typeof(DistrictEntityShootSystem))]
    public partial class DistrictTargetingFinalECBSystem : EntityCommandBufferSystem
    {
