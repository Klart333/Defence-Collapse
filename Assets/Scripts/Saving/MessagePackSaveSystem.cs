namespace Saving
{
    using System;
    using System.IO;
    using MessagePack; // Requires MessagePack-CSharp package
    using UnityEngine;

    /// <summary>
    /// Provides methods for saving and loading data using MessagePack binary serialization
    /// </summary>
    public class MessagePackSaveSystem : ISaveSystem
    {
        // File extension for saved files
        private const string FILE_EXTENSION = ".mpk";
        
        /// <summary>
        /// Saves data to a binary file using MessagePack
        /// </summary>
        ...
        /// <summary>
        /// Loads data from a MessagePack binary file
        /// </summary>
        ...
        public T LoadData<T>(string fileName, T defaultValue = default)
        {
            ...
            try
            {
                ...
                T loadedData = MessagePackSerializer.Deserialize<T>(bytes);
