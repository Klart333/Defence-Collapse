...
namespace Editor
{
	...
	public static class SpriteAtlasBaker
	{
		...
		static void _BakeAtlases()
		{
			...
			foreach (var obj in Selection.objects)
			{
				...
				if (obj is not SpriteAtlas atlas) continue;
				
				if (m_GetPreviewTextures.Invoke(null, new object[] { atlas }) is not Texture2D[] textures)
				{
